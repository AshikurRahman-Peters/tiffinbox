...
class Employee extends CI_Controller {
	...
	public function index(){
		...
		$data['page_title'] = 'All Staff :: TiffinBox';
	...
	public function create(){
		...
		$data['page_title'] = 'Create New Staff :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	public function operator_check($operator=Null){
	 ...
	 public function insert(){
		...
		$this->form_validation->set_rules('EmployeeDeptId', 'Department', 'required');
		$this->form_validation->set_rules('EmployeeDesignationId', 'Designation', 'required');  
	...
	public function update($id){
		...
		$data['page_title'] = 'Update Staff info :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	**/
	public function departments(){
		...
		$data['page_title'] = 'Departments :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	**/
	...
	public function designations(){
		...
		$data['page_title'] = 'Designations :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	public function createdesignation(){
		...
		$data['page_title'] = 'Create Designation :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	public function updatedesignation($id){
		...
		$data['page_title'] = 'Designation :: TiffinBox';
		$this->load->view('include/header',$data);
	...
	public function makecommittee(){
		...
		$data['page_title'] = 'Make Committee :: TiffinBox';
		$this->load->view('include/header',$data);
