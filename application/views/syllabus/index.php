...
<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header position-relative">
			<!--PAGE CONTENT BEGINS-->
				<a href="<?php echo base_url();?>syllabus/create">
						...
						<!--------------End of Message---------------------------------->
							<div class="row-fluid">
								...
								<div class="table-header">
									Results for "Latest Registered syllabus"
								</div>
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									//teacher information :
									 foreach($teacher as $item){
										...
										foreach(@$syllabus->result() as $row):
									?>		
									<tbody>
										<tr>
											<td class="center">
											...
											<td><?php echo @$teachers[$row->ClassTeacherId]; ?></td>
											 <td>
											 	<?php
											 	foreach($this->db->get_where('sections', array('ClassId'=>$row->Id))->result() as $section ):
													echo '<a href="'.base_url().'sections/update/'.$section->Id.'" data-rel="tooltip" data-original-title="Click to Update Section info" ><span class="btn btn-small">'.$section->SectionName.'</span></a>&nbsp;&nbsp;';		
												endforeach;	
											 	?>
											 </td >
											 <td>
											 	...
											 	foreach($this->db->get_where('subjects', array('SubjectClassId'=>$row->Id))->result() as $subject ):
													echo '<a href="'.base_url().'subjects/update/'.$subject->Id.'" data-rel="tooltip" data-original-title="Click to Update Subject info" ><span class="btn btn-small">'.$subject->SubjectName.'</span></a>&nbsp;&nbsp;';		
												endforeach;	
											 	?>
											 </td>	
											<td class="td-actions">
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="green" href="<?php echo base_url();?>syllabus/update/<?php echo $row->Id; ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" onclick="confirmdelete()" href="<?php echo base_url();?>syllabus/delete/<?php echo $row->Id; ?>">
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="<?php echo base_url();?>syllabus/update/<?php echo $row->id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																	<span class="green">
