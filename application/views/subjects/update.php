					...
					<div class="row-fluid">
						...
						<!--------------End of Message---------------------------------->
							...
							<?php echo form_open(base_url().'subjects/edit','class="form-horizontal"'); 
								...
								endforeach;
								echo '<br/><br/>'.form_label('Subject Teacher');
								echo form_dropdown('SubjectTeacherId',$teachers, (@$this->input->post('SubjectTeacherId')) ? @$this->input->post('SubjectTeacherId')  :$row->SubjectTeacherId);
								echo '<br/>'.form_error('SubjectTeacherId', '&nbsp;&nbsp;<span class="text-warning orange"><i class="icon-warning-sign"></i>&nbsp;', '</span>');
