<div class="page-content">
	<div class="row-fluid">
		<div class="span12 page-header position-relative">
			<!--PAGE CONTENT BEGINS-->
			<h1><i class="icon-hand-right icon-animated-hand-pointer blue"></i>Word Form Principal</h1>
        </div>
		<div class="row-fluid">
		    <div class="span12">
			    <!--------------Message---------------------------------->
                ...
                <?php echo form_open(base_url().'website/principal','class="form-horizontal" id="principle-form"');
                    foreach($principal->result() as $row):
                ?>
                    <?=form_hidden('principal_word', $row->principal_word);?>
...
<script type="text/javascript">
	...
	var editor = $('#editor1').ace_wysiwyg({
		toolbar:
		[
			'font',
			null,
		...
		'wysiwyg': {
			fileUploadError: showErrorAlert
                ...
                $('#principle-form').on('submit', function(e) {
                    ...
                    $('input[name="principal_word"]').val( html_content );
