					...
					<div class="row-fluid">
						...
						<!--------------Message---------------------------------->
							...
							?>
							 ...
							 ?>
							 <div class="control-group">
									<label class="control-label" for="form-field-tags">Sections of this Class:</label>

									<div class="controls">
										<input type="text" name="SectionName" id="form-field-tags" value=" 
										<?php //echo 
										if (@$this->input->post('SectionName')) :
											echo @$this->input->post('SectionName'); 
										
										else:
										
										foreach($this->db->get_where('sections', array('ClassId'=>$cls->Id))->result() as $sestion):
													echo $sestion->SectionName.',';		
									  ...
									  placeholder="Enter Section ..." /><br/>
										<span class="help-inline blue">* Add all section by coma separation!</span>
										<?php
							 ...
							 <?php } ?>
							<div class="control-group">
									<label class="control-label" for="form-field-tags1">Subjects of this Class:</label>

									<div class="controls">
										<input type="text" name="tags" id="form-field-tags1" value=" 
										<?php //echo 
