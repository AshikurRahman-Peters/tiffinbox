					...
					<div class="row-fluid">
						...
						<!--------------Message---------------------------------->
							...
							?>
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Department<span class="red">*</span></label>
									<div class="controls">
										<?php
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Designation<span class="red">*</span></label>
									<div class="controls">
										<?php
