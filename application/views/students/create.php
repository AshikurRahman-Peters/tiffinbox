						...
						<!--------------End of Message---------------------------------->
							<?php echo form_open_multipart(base_url().'students/insert','class="form-horizontal"'); ?>
							 ...
							 <div class="control-group">
								...
								<br/>	
								<div class="control-group">
									<label class="control-label" for="form-input-readonly">Parmanent Address <br/>
									<small><input type="checkbox" name="same_permanent" value="1" class="ace-checkbox-2" id="id-disable-check" />
										<label class="lbl" for="id-disable-check"> Same as Present Address!</small></label></label>
									<div class="controls">
